<?php
class ControllerReportProductOfferState extends Controller {
	private $error = array();
	
	public function index() {
		$this->load->language('report/product_offer_state');
	...
	public function getList() {
		...
		$this->load->model('report/product_offer_state');
		
		$results = $this->model_report_product_offer_state->getProducts();
		...
		$this->response->setOutput($this->load->view('report/product_offer_state', $data));
	}
